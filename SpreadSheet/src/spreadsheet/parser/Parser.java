...
public class Parser implements ParserConstants {
        ...
        protected static final int BUILD_OK = 1;
        protected static final int BUILD_ERROR = -1;
    ...
    if (jj_2_54(3)) {
      ...
      if (jj_2_52(3)) {
        ...
        throw new ParseException();
                                                  ...
                                                  {if (true) return BUILD_OK;}
    } else if (jj_2_55(3)) {
      jj_consume_token(EOL);
    } else if (jj_2_56(3)) {
      jj_consume_token(0);
                 {if (true) return BUILD_ERROR;}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
...
// ////////////////////////////////////////////////////////////////////////
  final public double compute(Map<String,Double> vals) throws ParseException, MissingValueException {
        Token t;
        double f;
    if (jj_2_104(3)) {
      jj_consume_token(EQUALS);
     ...
     {if (true) throw new ParseException("Invalid Formula.");}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public double computeExpression(Map<String,Double> vals) throws ParseException, MissingValueException {
        double value, tmp;
  ...
  final public double computeTerm(Map<String,Double> vals) throws ParseException, MissingValueException {
        double c1, c2;
        double value, tmp;
  ...
  final public double computeExp(Map<String, Double> vals) throws ParseException, MissingValueException {
        double value, tmp;
  ...
  final public double computeUnary(Map<String, Double> vals) throws ParseException, MissingValueException {
  double value;
    if (jj_2_113(3)) {
      jj_consume_token(MINUS);
  ...
  final public double computeFactor(Map<String,Double> vals) throws ParseException, MissingValueException {
        Token t=null;
        double s, s0;
        boolean b;
    if (jj_2_115(3)) {
      ...
      t = jj_consume_token(ID);
                if(vals.containsKey(t.image)){
                        {if (true) return vals.get(t.image);}
                }

                {if (true) throw new MissingValueException("Missing value for cell located at: "+t.image);}
    } else if (jj_2_119(3)) {
      t = jj_consume_token(NUM);
          {if (true) return Double.valueOf(t.image);}
    } else if (jj_2_120(3)) {
      ...
      s = computeExpression(vals);
      jj_consume_token(R_BRACKET);
          {if (true) return Math.log(s);}
    } else if (jj_2_122(3)) {
      jj_consume_token(SIN);
      jj_consume_token(L_BRACKET);
      s = computeExpression(vals);
      jj_consume_token(R_BRACKET);
          {if (true) return Math.sin(s);}
    } else if (jj_2_123(3)) {
      jj_consume_token(COS);
      jj_consume_token(L_BRACKET);
      s = computeExpression(vals);
      jj_consume_token(R_BRACKET);
          {if (true) return Math.cos(s);}
    } else if (jj_2_124(3)) {
      jj_consume_token(TAN);
      jj_consume_token(L_BRACKET);
      s = computeExpression(vals);
      jj_consume_token(R_BRACKET);
          {if (true) return Math.tan(s);}
    } else if (jj_2_125(3)) {
      jj_consume_token(ASIN);
      jj_consume_token(L_BRACKET);
      s = computeExpression(vals);
      jj_consume_token(R_BRACKET);
          {if (true) return Math.asin(s);}
    } else if (jj_2_126(3)) {
      jj_consume_token(ATAN);
      jj_consume_token(L_BRACKET);
      s = computeExpression(vals);
      jj_consume_token(R_BRACKET);
          {if (true) return Math.atan(s);}
    } else if (jj_2_127(3)) {
      jj_consume_token(ACOS);
      jj_consume_token(L_BRACKET);
      s = computeExpression(vals);
      jj_consume_token(R_BRACKET);
          {if (true) return Math.acos(s);}
    } else if (jj_2_128(3)) {
      jj_consume_token(FLOOR);
      jj_consume_token(L_BRACKET);
      s = computeExpression(vals);
      jj_consume_token(R_BRACKET);
          {if (true) return Math.floor(s);}
    } else if (jj_2_129(3)) {
      jj_consume_token(CEIL);
      jj_consume_token(L_BRACKET);
      s = computeExpression(vals);
      jj_consume_token(R_BRACKET);
          {if (true) return Math.ceil(s);}
    } else if (jj_2_130(3)) {
      jj_consume_token(MAX);
      jj_consume_token(L_BRACKET);
      s = computeExpression(vals);
  ...
  final public boolean computeBoolean(Map<String,Double> vals) throws ParseException, MissingValueException {
        boolean b, b0;
    b = computeAnd(vals);
    label_14:
    while (true) {
  ...
  final public boolean computeAnd(Map<String,Double> vals) throws ParseException, MissingValueException {
        boolean b, b0;
    b = computeNot(vals);
    label_15:
    while (true) {
  ...
  final public boolean computeNot(Map<String, Double>  vals) throws ParseException, MissingValueException {
  boolean b;
    if (jj_2_135(3)) {
  ...
  final public boolean computeComparison(Map<String,Double> vals) throws ParseException, MissingValueException {
        boolean b=false;
        double s, s0;
    if (jj_2_143(3)) {
      s = computeExpression(vals);
  ...
  final private boolean jj_3_116() {
    if (jj_scan_token(NEGINFINITY)) return true;
    return false;
  }
  ...
  final private boolean jj_3_115() {
    if (jj_scan_token(POSINFINITY)) return true;
    return false;
  }
