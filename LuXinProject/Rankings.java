...
public class Rankings extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7131773139860555793L;
	...
	private JScrollPane getJScrollPane() {
		if (jScrollPane == null) {
			...
			jScrollPane.setBounds(new java.awt.Rectangle(27,163,558,243));
	...
	private void display(){
		...
		try {
			...
			rs = sql.executeQuery("SELECT * FROM Info ORDER BY Reward_USD DESC");
			
			String headings = "#  "+ spacing("Name")+"Reward";
			...
			{		
				...
				String Reward = rs.getString(11);
				
				String line = (size+1)+". "+ spacing(name[size])+Reward;
				size++;
	...
	private JButton getBTNBack() {
		if (BTNBack == null) {
			...
			BTNBack.setLocation(new java.awt.Point(490,77));
	...
	private JButton getBTNLogout() {
		if (BTNLogout == null) {
			...
			BTNLogout.setLocation(new java.awt.Point(490,110));
	...
	private JButton getBTNView(){
		if (BTNView == null) {
			BTNView = new JButton();
			BTNView.setBounds(new java.awt.Rectangle(250,422,129,32));
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			LBLType = new JLabel();
			LBLType.setBounds(new java.awt.Rectangle(251,111,154,34));
